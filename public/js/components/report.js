class Report extends React.Component {
    ...
    async componentDidMount() {
        ...
        await axios.get(`/api/userAttempt`).then(res => {
            this.setState({ userAttempt: res.data });
        });

        await axios.get(`/api/estagios`).then(res => {
            this.setState({ estagios: res.data });
        });

        await axios.get(`/api/midias`).then(res => {
            ...
            <form className="col-md-6 offset-md-3" onSubmit={this.handleSubmit}>
                <div className="form-group">
                    ...
                    <select
                        ...
                        name="colaborador_id"
                        value={this.state.colaborador_id}
                        onChange={e =>
                            this.setState({ colaborador_id: e.target.value })
                        }
                    >
                        <option>Todos</option>
                        {users.map(user => (
                ...
                <div className="form-group">
                    ...
                    <select
                        ...
                        onChange={e =>
                            this.setState({ estagio: e.target.value })
                        }
                    >
                        <option>Todos</option>
                ...
                <div className="form-group">
                    ...
                    <label className="ls-label">
                        ...
                        <input
                            ...
                            className="datepicker ls-daterange"
