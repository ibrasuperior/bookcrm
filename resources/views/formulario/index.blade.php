...
<div class="container-fluid">
    ...
    <form action="/formulario/envia" id="formMy" class="ls-form" method="post">
        ...
        <div style="margin-top:20px;">
            ...
            <label class="ls-label col-md-6">
                <input autocomplete="off" required id="telefone" placeholder="Celular DD - XXXXX-XXXX" type="text"
                    name="celular">
            </label>
            ...
            <label class="ls-label col-md-6">
                <input OnKeyUp="mascaraData(this, 'dd');" maxlength="10" required id="dd" autocomplete="off"
                    placeholder="Data de Nascimento" type="text" name="dataNasc">
            </label>
            ...
            <label class="ls-label col-md-6">
                ...
                <input autocomplete="off" required id="valor2" maxlength="10" onkeyup="formatarMoeda('valor2');"
                    placeholder="Valor da Matrícula" type="text" name="valorMatricula">
            </label>

            <label class="ls-label col-md-6">
                <input OnKeyUp="mascaraData(this, 'ddd');" required maxlength="10" id="ddd" autocomplete="off"
                    placeholder="Vencimento da Matrícula" type="text" name="vencimentoMatricula">
            </label>

            <label class="ls-label col-md-6">
                <input autocomplete="off" id="valor3" required maxlength="10" onkeyup="formatarMoeda('valor3');"
                    placeholder="Valor da Mensalidade" type="text" name="valorMensalidade">
            </label>

            <label class="ls-label col-md-6">
                <input OnKeyUp="mascaraData(this, 'dd2');" required maxlength="10" id="dd2" autocomplete="off"
                    placeholder="Vencimento da Mensalidade" type="text" name="vencimentoMensalidade">
            </label>
            ...
            <label class="ls-label col-md-6">
                <input id="valorTotal" required maxlength="10" onkeyup="formatarMoeda('valorTotal')" autocomplete="off"
                    placeholder="Valor Total do curso (sem matrícula)" type="text" name="valorTotal">
            </label>
