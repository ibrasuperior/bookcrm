  ...
  <tbody>
    @foreach( $users as $user )
      <tr>
        ...
        <td class="ls-txt-center">{{$user->permissoes}}</td>
        <td class="ls-txt-center ls-regroup">
            <div data-ls-module="dropdown" class="ls-dropdown">
                ...
                <ul class="ls-dropdown-nav" aria-hidden="true">
                    ...
                    <li><a href="/users/delete/{{$user->id}}" onclick="return confirm('tem certeza que quer excluir?')" class="ls-color-danger" role="option">Excluir</a></li>
                </ul>
            </div>
        </td>    
      </tr>
