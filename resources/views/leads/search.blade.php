...
<div class="container-fluid">
      <h1 class="ls-title-intro ls-ico-users">Pesquisa</h1>
...
<table class="ls-table  ls-bg-header ">
  <thead>
    <tr>
      ...
      <th class="ls-txt-center ls-data-descending"><a>Operador </a></th>
  ...
  <tbody>
    @foreach( $leads as $lead )
      <tr class="shadow" >
        ...
        <td class="ls-txt-center">
          @if( isset($lead->colaborador->name) )
        ...
        <td class="ls-txt-center ls-regroup">
            <div data-ls-module="dropdown" class="ls-dropdown">
                ...
                <ul class="ls-dropdown-nav" aria-hidden="true">
                    ...
                    @if( \Auth::user()->id == $lead->colaborador_id)
